...
const Experience = () => {
  return (
    <section id="experience">
      <h2 className="heading-experience">My Skills</h2>
      <h5 className="cen-experience">What skills I have</h5>
      <div className="container experience_container">
        ...
        {/* this card is only for responsiveness */}

        <div className="experience_common responsive-exp">
          <div className="experience_content">
            <article className="experience_details">
              <BsPatchCheckFill className="experience_details-icon" />
              <div>
